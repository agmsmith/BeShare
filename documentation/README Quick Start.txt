...
1.	Run BeShare by double-clicking the icon.
...
4.	If you see one you like, click on it, then click "Download Selected Files".
	With any luck, that file will soon appear in the "BeShare/downloads" subdirectory
	of your home folder. (This directory will be created  if it doesn't exist.)
4a.	The "Information" button on the left can show you extra info on the
	selected files before downloading, if the source has provided them.
	(Only available if both you and the source are running BeShare 3.00.)
5.	To make a file or directory on your local disk available to other BeShare 
	users, move or copy it into the "BeShare/shared" directory (or create a symbolic
	link to it) and leave your BeShare client logged in to the server.
	See the main BeShareDocs.txt for how to add information to the file for
	others to see.
