...
public:
   ...
   {
      for (int i=0; i<GetNumItemsInTuple(); i++) (*this)[i] = first + 50.0f - (float)i;
      _count = counter++;
   }
   ...
   {
      printf("{");
      for (int i=0; i<GetNumItemsInTuple(); i++) printf("%.1f%s", (*this)[i], (i==GetNumItemsInTuple()-1)?"":",");
      printf("}(c=%lu)", _count);
   }
...
public:
   ...
   {
      printf("{");
      for (int i=0; i<GetNumItemsInTuple(); i++) printf("[%s]%s", (*this)[i](), (i==GetNumItemsInTuple()-1)?"":",");
      printf("}");
   }
...
int main()
{
   printf("Test 1, with tuple using 3 ints\n");
   {
      MyTuple a;
      a[0] = 5; a[1] = 10; a[2] = 15;
      MyTuple b;
