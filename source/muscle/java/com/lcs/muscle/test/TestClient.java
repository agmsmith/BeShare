...
import com.lcs.muscle.iogateway.AbstractMessageIOGateway;
import com.lcs.muscle.message.Message;
import com.lcs.muscle.client.MessageTransceiver;
import com.lcs.muscle.client.StorageReflectConstants;
import com.lcs.muscle.support.UnflattenFormatException;
import com.lcs.muscle.thread.MessageListener;
import com.lcs.muscle.thread.MessageQueue;
...
public class TestClient implements MessageListener, StorageReflectConstants
{
   public static final void main(String args[])
   {
      if (args.length != 1)
      {
         System.out.println("Usage java com.lcs.muscle.test.TestClient 12.18.240.15");
         System.exit(5);
      }
